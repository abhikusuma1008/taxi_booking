...
with sqlite3.connect(r'D:\Users\sreet\Desktop\ms\cv\Users.db') as db:
    c = db.cursor()
...
class user:
    ...
    def login(self):
        ...
        if result:
            ...
            self.head.configure(fg="green",font=("times new roman",25,"bold"))
...
class travel:
    ...
    def __init__(self,root):
        self.root = root
        self.root.title("Taxi Booking System In MRCET")
   ...
   #================================================mainframe========================================================================
        ...
        self.lblTitle=Label(Tops,font=('arial',70,'bold'),text=" Taxi Booking System in MRCET ")
        self.lblTitle.grid()
